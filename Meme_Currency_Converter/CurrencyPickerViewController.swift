...
class CurrencyPickerViewController: UITableViewController {
    ...
    var secondDelegate: ChangeSecondCurrency?
    var choosingSecond = false
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print(choosingSecond)
        delegate?.changeCurrencyCode(newCode: code, choosingSecond: choosingSecond)
